...
function Card({
  ...
  return (
    <div className="font-custom bg-white border-black max-w-[327px] sm:max-w-[384px] p-6 rounded-[20px] shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] flex-col">
      <img src={blogImage} className="rounded-[20px] w-full h-50 object-center"></img>
      <div className="my-6">
